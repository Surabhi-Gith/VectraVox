...
<div style="border: 2px solid #ddd; padding: 10px; border-radius: 8px; display: flex; flex-wrap: wrap; gap: 10px; background-color: #f9f9f9;">
...
|  HTML |  CSS |  JavaScript |  Node.js |  React |  MongoDB |  Docker |
|-------|------|-------------|----------|--------|----------|---------|
